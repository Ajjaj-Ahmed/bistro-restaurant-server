...
// STRIPE_SECRET_KEY=sk_test_51RAmG3IzAIJkATc0MJpRgiLvO45WeUpQbasHg7nR0QPR90QpGKAgPVhEKD16gg4HX84rZecsXvdzuMyb9Fl1EML000NXWx61NE
...
async function run() {
  try {
    ...
    app.post('/users', async (req, res) => {
      const user = req.body;
      // insert email if user does not exit in db
